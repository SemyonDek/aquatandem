function addPhotos() {
    ...
    var src;
    var buttonLeft = '<button class="del-item-favourites_button" type="button"  onclick="delPhoto(';
    var buttonRight = ')"><img src="../img/main/del_photos.png" alt="" class="del-item-favourites"></button>';
    reader.onload = function () {
        ...
        if (document.getElementById('file_photo_1').files.length == 0 && document.getElementById('photo_1') == null) {
            ...
            div.id = 'photo_1';
            div.innerHTML = buttonLeft + "'photo_1'" + buttonRight;
            ...
            div.id = 'photo_2';
            div.innerHTML = buttonLeft + "'photo_2'" + buttonRight;
            div.style.backgroundImage = "url(" + src + ")";
            block.append(div);
            ...
            div.id = 'photo_3';
            div.innerHTML = buttonLeft + "'photo_3'" + buttonRight;
            div.style.backgroundImage = "url(" + src + ")";
            block.append(div);
            ...
            div.id = 'photo_4';
            div.innerHTML = buttonLeft + "'photo_4'" + buttonRight;
            div.style.backgroundImage = "url(" + src + ")";
            block.append(div);
            ...
            div.id = 'photo_5';
            div.innerHTML = buttonLeft + "'photo_5'" + buttonRight;
            div.style.backgroundImage = "url(" + src + ")";
            block.append(div);
